...
Each paired directory under `plans/fix_css_for_updated_codebase.md/captures`, e.g.
`plans/fix_css_for_updated_codebase.md/captures/orig/a_search` and
`plans/fix_css_for_updated_codebase.md/captures/port3000/a_search`, contain
...
1. Run
   `./capture-diff --port 3000 --target-dir plans/fix_css_for_updated_codebase.md/captures --capture-list plans/fix_css_for_updated_codebase.md/exemplar_urls.tsv --name <name of the example you're working on , e.g., 'splash'> --only port`
...
`plans/fix_css_for_updated_codebase.md/captures/port3000/<name>/CHANGES.md`
